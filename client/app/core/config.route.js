...
angular.module('app')
    ...
    //       //     if (requiredLogin && !LoginServices.isAuthenticated()) {
    ...
    //       //   console.log("is authenticated",LoginServices.isAuthenticated())
    ...
    .config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider',
        ...
        function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
            ...
            $stateProvider
                ...
                .state('login', {
                    url: '/login',
                    templateUrl: 'app/app/taskpro/authentication.html',
                ...
                .state('app.addSubCategory', {
                    ...
                    templateUrl: 'app/addSubCategory/addSubCategory.html',
                ...
                //Add SuperSubcategory
                .state('app.addSuperSubCategory', {
                    url: '/addSuperSubCategory/:id',
                    templateUrl: 'app/addSuperSubCategory/addSuperSubCategory.html',
                    controller: 'addSuperSubCategoryCtrl',
                    controllerAs:'vm',
                   // data: {requiredLogin: false},
                    resolve: {
               ...
               .state('app.ui-timeline', {
                ...
                function authenticate($q, LoginServices, $state, $timeout,$location) {
